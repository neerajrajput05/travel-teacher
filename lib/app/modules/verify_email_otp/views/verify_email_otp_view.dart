...
class VerifyEmailOtpView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<VerifyEmailOtpController>(
        init: VerifyEmailOtpController(),
        builder: (controller) {
                  ...
                  children: [
                    ...
                    RoundShapeButton(
                        ...
                        onTap: () async {
                          ...
                          controller.confirmOTP(context, controller.otp.value,controller.emailID.value.toString());
                          // .then((value) async {
                            ...
                            recognizer: TapGestureRecognizer()
                              ..onTap = () {
                                controller.reSendOTP(
                                    context, controller.emailID.value.toString());
                              },
                          ),
                        ],
                      ),
