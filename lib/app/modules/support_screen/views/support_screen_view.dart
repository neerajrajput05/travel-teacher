    ...
    return GetX<SupportScreenController>(
      ...
      builder: (controller) {
        return Scaffold(
            ...
            body: (controller.supportTicketList.isEmpty)
                            ...
                            children: [
                              Row(
                                children: [
                                  Expanded(
                                    child: Text(
                                      controller.supportTicketList[index].title
                                          .toString(),
                                  ...
                                  Text(
                                    controller.supportTicketList[index].status
                                                .toString() ==
                                            "pending"
                                        ? "Pending"
                                        : controller.supportTicketList[index]
                              ...
                              Text(
                                controller.supportTicketList[index].description
                                    .toString(),
                                maxLines: 3,
