                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Obx(
                        () => Column(
                          ...
                          children: [
                            PriceRowView(
                              price: controller.bookingModel.value.subTotal
                                  .toString(),
                              title: "Amount".tr,
                            ...
                            ListView.builder(
                              ...
                              itemCount:
                                  controller.bookingModel.value.taxList!.length,
                              shrinkWrap: true,
                    ...
                    Obx(
                      () => Column(
                        ...
                        children: [
                          Visibility(
                            visible: Constant.paymentModel!.cash != null &&
                                Constant.paymentModel!.cash!.isActive == true,
                            child: Column(
                              children: [
                                Container(
                          ...
                          Visibility(
                            visible: Constant.paymentModel!.wallet != null &&
                                Constant.paymentModel!.wallet!.isActive == true,
                            child: Column(
                              children: [
                                Container(
                                  transform: Matrix4.translationValues(
                                    ...
                                    onChanged: (value) {
                                      controller.selectedPaymentMethod.value =
                                          Constant.paymentModel!.wallet!.name
                                              .toString();
                                      controller
                                              .bookingModel.value.paymentType =
                                          Constant.paymentModel!.wallet!.name;
                                    },
                                  ),
                                ),
                          ...
                          Visibility(
                            visible: Constant.paymentModel!.paypal != null &&
                          ...
                          Visibility(
                            visible: Constant.paymentModel!.strip != null &&
                                Constant.paymentModel!.strip!.isActive == true,
                            child: Column(
                              children: [
                                Container(
                                  transform: Matrix4.translationValues(
                          ...
                          Visibility(
                            visible: Constant.paymentModel!.razorpay != null &&
                                Constant.paymentModel!.razorpay!.isActive ==
                                    true,
                            child: Column(
                              children: [
                                Container(
                          ...
                          Visibility(
                            visible: Constant.paymentModel!.payStack != null &&
                                Constant.paymentModel!.payStack!.isActive ==
                                    true,
                            child: Column(
                              children: [
                                Container(
                          ...
                          Visibility(
                            visible: Constant.paymentModel!.mercadoPago !=
                                    null &&
                                Constant.paymentModel!.mercadoPago!.isActive ==
                                    true,
                            child: Column(
                              children: [
                                Container(
                          ...
                          Visibility(
                            visible: Constant.paymentModel!.payFast != null &&
                                Constant.paymentModel!.payFast!.isActive ==
                                    true,
                            child: Column(
                              children: [
                                Container(
                          ...
                          Visibility(
                            visible: Constant.paymentModel!.flutterWave !=
                                    null &&
                                Constant.paymentModel!.flutterWave!.isActive ==
                                    true,
                            child: Column(
                              children: [
                                Container(
