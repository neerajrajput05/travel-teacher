  ...
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    return ThemeData(
      ...
      timePickerTheme: TimePickerThemeData(
        backgroundColor:
            isDarkTheme ? AppThemData.grey700 : AppThemData.grey200,
        dialTextStyle: TextStyle(
            fontWeight: FontWeight.bold,
            color: isDarkTheme ? AppThemData.grey100 : AppThemData.grey800),
        dialTextColor: isDarkTheme ? AppThemData.grey100 : AppThemData.grey800,
        hourMinuteTextColor:
            isDarkTheme ? AppThemData.grey100 : AppThemData.grey800,
        dayPeriodTextColor:
            isDarkTheme ? AppThemData.grey100 : AppThemData.grey800,
      ),
    );
